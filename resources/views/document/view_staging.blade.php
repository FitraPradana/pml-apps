        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-auto float-right ml-auto">
                    <div class="btn-group">
                        <a href="{{ url('doc_stg_save') }}" onclick="return confirm ('Are you sure to Get Data Document From ERP?')" class="btn btn-info"><i class="las la-sync"></i> Generate DOCUMENT from ERP</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        // $(document).ready(function () {
            ...
            $('#datatables').DataTable({
                ...
                columns: [
                    ...
                    { data: 'LastSettleVoucher', name: 'LastSettleVoucher'},
                    { data: 'LastSettleDate', name: 'LastSettleDate'},
                    { data: 'Txt', name: 'Txt' },
                    { data: 'AmountCur', name: 'AmountCur' },
