    ...
    <div class="content container-fluid">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <form action="{{ route('fixed_assets.update', $asset->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{ $asset->fixed_assets_name }}" name="fixed_assets_name" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{ $asset->main_fixed_assets }}" readonly>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" @error('acquisition_date')
                                    is-invalid
                                @enderror type="text" value="{{ old('acquisition_date', $asset->acquisition_date) }}" name="acquisition_date" disabled required>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" @error('net_book_value')
                                    is-invalid
                                @enderror type="text" value="{{ old('net_book_value', $asset->net_book_value) }}" name="net_book_value" required>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Remarks</label>
                                <input class="form-control" @error('remarks_fixed_assets')
                                    is-invalid
                                @enderror type="text" value="{{ old('remarks_fixed_assets', $asset->remarks_fixed_assets) }}" name="remarks_fixed_assets" required>
