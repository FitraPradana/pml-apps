            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <div class="btn-group">
                            <a href="{{ url('fixed_assets_stg_save') }}"
                                onclick="return confirm ('Are you sure to Get Data From ERP?')" class="btn btn-info"><i
                                    class="las la-sync"></i> Generate Asset from ERP</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if (session()->has('error_site_kosong'))
                        <div class="alert alert-danger" role="alert">
                            {{ session('error_site_kosong') }} <a href="{{ url('sites_stg_index') }}"> Form SITES Staging
                                >>> </a>
                        </div>
                    @endif
        ...
        $(function() {
            ...
            $('#datatables').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'MaintenanceInfo3',
                        name: 'MaintenanceInfo3'
                    },
                    {
                        data: 'KREVesselId',
                        name: 'KREVesselId'
