                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img alt=""
                                                src="{{ asset('/') }}assets/img/people.png"></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">{{ $employees->emp_name }}</h3>
                                                <h6 class="text-muted">UI/UX Design Team</h6>
                                                <small class="text-muted">Web Designer</small>
                                                <div class="staff-id">Employee ID : {{ $employees->emp_accountnum }}</div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <div class="text"><a href="">{{ $employees->emp_phone }}</a>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="title">Email:</div>
                                                    <div class="text"><a href="">{{ $employees->emp_email }}</a>
                                                    </div>
                                                </li>
                                                <li>
