        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-auto float-right ml-auto">
                    <div class="btn-group">
                        <a href="{{ url('vessels_stg_save') }}" onclick="return confirm ('Are you sure to Get Data From ERP?')" class="btn btn-info"><i class="las la-sync"></i> Generate VESSEL from ERP</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            $('#datatables').DataTable({
                ...
                columns: [
                    ...
                    { data: 'VessID', name: 'VessID' },
                    { data: 'VessName', name: 'VessName'},
                    { data: 'VessType', name: 'VessType'},
                    { data: 'VessClassID', name: 'VessClassID' },
                ]
            });
        });
</script>
