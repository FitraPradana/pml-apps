...
@section('title', 'Data Registrasi Crew')
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Registrasi Crew</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Registrasi Crew</a></li>
                            <li class="breadcrumb-item active">Registrasi Crew</li>
                        </ul>
                    </div>
